...
const Swap = () => {
    ...
    const { BTC, ETH, USDT, DAI, USDC, hardcodedUserBalance, setSwapBuy, setSwapShell } = useAppContext();
        ...
        if (swapAmount.buy > 0 && swapAmount.shell > 0) {
            setTimeout(() => {
                ...
                setSwapShell({
                    ...
                    change: coinDictionary[buyCoin].market_data?.current_price.usd / coinDictionary[shellCoin].market_data?.current_price.usd,
        ...
        <PageLayout head='Belo | Swap'>
            {
                !coinDictionary[shellCoin].market_data?.current_price.usd ?
                    ...
                    <section className=' flex flex-col items-center w-128 h-128 sm:w-80 sm:h-auto mx-auto'>
                            ...
                            <div className='flex w-96 sm:w-80 h-12 my-4'>
                                ...
                                <details className='m-auto cursor-pointer hover:transition-transform hover:-translate-x-1 z-50 sm:z-40'>
                                    ...
                                    <menu role='menu' className='relative'>
                                        <div role='none' className='flex flex-col absolute top-0 sm:right-0 bg-white w-40 py-4 px-6 rounded dark:bg-slate-400 dark:text-gray-100'>
                                            {
                        ...
                        <button onClick={() => handleConfirm()} className=' h-12 mt-4 from-blue-500 bg-gradient-to-br to-indigo-500  dark:from-blue-700 dark:to-indigo-700transition-all p8 w-96  sm:w-80 rounded text-white text-lg hover:ring'>Buy</button>
                    </section >}
        </PageLayout >
    )
}
